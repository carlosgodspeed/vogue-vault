...
<body>
    ...
    <div class="background">
        <header>
            ...
            <div class="icon"><span><ion-icon name="bag-handle-outline"></ion-icon></span></div><!--icon-->
        </header>
    </div><!--background-->
        ...
        <div class="Container-card-1">
            <div class="cards">
                <a href="URL_DO_DESTINO">
                    <img src="img/casaco-marron.png">
                </a>
            </div><!--cards-->

            <div class="cards">
                <a href="">
                    <img src="img/blusa-branca.png">
                </a>
            </div><!--cards-->

            <div class="cards">
                <a href="URL_DO_DESTINO">
                    <img src="img/blusa-canva.png">
                </a>
            </div><!--cards-->
